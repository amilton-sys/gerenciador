...
function handleUpdateExpense() {
    ...
    const name = document.getElementById("nomeUpdate").value.trim();
    const value = document.getElementById("valorUpdate").value.trim();
    const date = document.getElementById("dateUpdate").value.trim();
    const situation = document.getElementById("situacaoUpdate").value;

    fetch("/updateExpense", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ id, name, value, date, situation })
    }).then(response => {
...
function populateEditModal(data) {
    ...
    document.getElementById("nomeUpdate").value = data.name;
    document.getElementById("valorUpdate").value = data.value;
    document.getElementById("dateUpdate").value = data.date;
    document.getElementById("situacaoUpdate").value = data.situation;
}
